...
def main():
    ...
    parser.add_argument(
        "--out",
        type=str,
        default=str(VISION_DIR / "calibration/cam0_z_calib.npz"),
    )
    parser.add_argument(
        "--json-out",
        type=str,
        default=str(VISION_DIR / "calibration/cam0_z_points.json"),
    )
    ...
    parser.add_argument(
        "--det-model",
        type=str,
        default=str(VISION_DIR / "yolo_experiments/best.pt"),
    )
